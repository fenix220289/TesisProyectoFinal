      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Ingrese los datos del formulario para registrarse</p>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="/register">
                ...
                <div class="form-check form-check-info text-left">
                  ...
                  @error('agreement')
                    <p class="text-danger text-xs mt-2">Primero, debe aceptar los términos y condiciones.</p>
                  @enderror
                </div>
                <div class="text-center">
                  <button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">Registrar</button>
                </div>
                <p class="text-sm mt-3 mb-0">Ya tiene una cuenta? <a href="login" class="text-dark font-weight-bolder">Entrar</a></p>
              </form>
            </div>
          </div>
        </div>
